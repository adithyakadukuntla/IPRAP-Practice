...
resource "aws_subnet" "public" {
  ...
  tags = merge(var.tags, { Name = "${local.name_prefix}-public-${var.azs[count.index]}", Tier = "public" })
}
...
resource "aws_subnet" "private" {
  ...
  availability_zone = var.azs[count.index]
  tags = merge(var.tags, { Name = "${local.name_prefix}-private-${var.azs[count.index]}", Tier = "private" })
}
